...
public class XmlKit {
	...
	public static Document readXML(File file) {
		...
		if (!file.exists()) {
			throw new SystemErrorException(Result.FAIL_CODE, "File [" + file.getAbsolutePath() + "] not a exist!");
		}
		if (!file.isFile()) {
			throw new SystemErrorException(Result.FAIL_CODE, "[" + file.getAbsolutePath() + "] not a file!");
		}
		...
		try {
			...
			throw new SystemErrorException(Result.FAIL_CODE, "Parse xml file [" + file.getAbsolutePath() + "] error!", e);
		}
	}
	...
	public static Document parseXml(String xmlStr) {
		if (StringKit.isBlank(xmlStr)) {
			throw new SystemErrorException(Result.FAIL_CODE, "Xml content string is empty !");
		}
		...
		try {
			...
			throw new SystemErrorException(Result.FAIL_CODE, "Parse xml file [" + xmlStr + "] error!", e);
		}
	}
	...
	public static String toStr(Document doc, String charset) {
		try {
			...
			throw new SystemErrorException(Result.FAIL_CODE, "Trans xml document to string error!", e);
		}
	}
	...
	public static Document createXml(String rootElementName) {
		...
		try {
			...
			throw new SystemErrorException(Result.FAIL_CODE, "Create xml document error!", e);
		}
