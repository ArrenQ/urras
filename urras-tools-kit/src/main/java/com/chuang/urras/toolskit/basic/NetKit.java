 ...
 */
public class NetKit {
	private static Logger logger = LoggerFactory.getLogger(NetKit.class);
	...
	public static Set<String> localIpv4s() {
		...
		if(networkInterfaces == null) {
			throw new SystemErrorException(Result.FAIL_CODE, "Get network interface error!");
		}
	...
	public static String toAbsoluteUrl(String absoluteBasePath, String relativePath) {
		try {
			...
			throw new SystemErrorException(Result.FAIL_CODE, StringKit.format("To absolute url [{}] base [{}] error!", relativePath, absoluteBasePath), e);
		}
	}
