...
public class PathKit {
	...
	public static String getRootClassPath() {
		if (rootClassPath == null) {
			try {
				String path = Objects.requireNonNull(PathKit.class.getClassLoader().getResource("")).toURI().getPath();
				rootClassPath = new File(path).getAbsolutePath();
			}
			catch (Exception e) {
				String path = Objects.requireNonNull(PathKit.class.getClassLoader().getResource("")).getPath();
				rootClassPath = new File(path).getAbsolutePath();
			}
		}
