...
public class FileKit {
	...
	public static File[] ls(String path) {
		...
		throw new SystemErrorException(Result.FAIL_CODE, StringKit.format("Path [{}] is not directory!", path));
	}
	 ...
	 * @param dirPath 目录
	 * @return 是否为空
	 * @exception SystemErrorException IOException
	 */
	...
	public static List<String> listFileNames(String path) {
		...
		try {
			...
			throw new SystemErrorException(Result.FAIL_CODE, StringKit.format("Can not read file path of [{}]", path), e);
		}
		return paths;
	}
