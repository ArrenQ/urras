...
public class URLKit {
	 ...
	 * @return URL
	 * @exception SystemErrorException MalformedURLException
	 */
	 ...
	 * @param charset 编码
	 * @return 编码后的URL
	 * @exception SystemErrorException UnsupportedEncodingException
	 */
	 ...
	 * @param uriStr URI路径
	 * @return path
	 * @exception SystemErrorException URISyntaxException
	 */
